...
urlpatterns = [
    ...
    path('split-cart-confirmation/', views.split_cart_confirmation, name='split_cart_confirmation'),
    path('confirm-cart-split/', views.confirm_cart_split, name='confirm_cart_split'),
